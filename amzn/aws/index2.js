...
function onIntent(intentRequest, session, callback) {
    ...
    } else if ("askNumberIntent" === intentName) {
        handleAnswerRequest(intent, session, callback);
    } else if ("askPayloadIntent" === intentName) {
        handleAnswerRequest(intent, session, callback);
    } 
    /*
    else if ("AMAZON.YesIntent" === intentName) {
...
function handleAnswerRequest(intent, session, callback) {
    ...
    var definePayload = session.attributes && session.attributes.payload;
    var defineNumber = session.attributes && session.attributes.number;
