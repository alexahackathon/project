        // Twilio Credentials 
        var accountSid = 'ACa7428642d9aeb496848472d4600d3761';
        var authToken = '363ce43d348e98f2946188c57412c1f5';
        var fromNumber = '+18082011067';
        ...
        function SendSMS(destination, callback) {
            https.get('https://radiant-meadow-52062.herokuapp.com/api/contacts/' + destination.toLowerCase(), function(res) {
                ...
                res.on('end', function(){
                    body = JSON.parse(body);
                        ...
                        UseTwilio(messageString, callback)
                })
            })
        }

        function UseTwilio(messageString, callback) {
        ...
        function onIntent(intentRequest, session, callback) {
            ...
            console.log(intentRequest.intent.slots.nameInput);
            
            if("askNameIntent" === intentName){
                console.log("received SendSms intent.");
                var destination = intentRequest.intent.slots.nameInput.value;
                // var text = intentRequest.intent.slots.Text.value;
                console.log("Sending sms to : "+ destination+" with text: ");
